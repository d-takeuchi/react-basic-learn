    ...
    <SContainer>
      ...
      <div>
        ...
        <input
          type="text"
          name="year"
          value={inputData.birthday.year?.toString()}
        ...
        <input
          type="text"
          name="month"
          value={inputData.birthday.month?.toString()}
          onChange={onChangeSetBirthDay}
        />
        月
        <input
          type="text"
          name="day"
          value={inputData.birthday.day?.toString()}
          onChange={onChangeSetBirthDay}
        />
        日
      </div>
